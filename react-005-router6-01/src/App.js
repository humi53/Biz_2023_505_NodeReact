 ...
 * 보통 react-router-dom 에서 다른 페이지를 열고자 할때 NaviLink를 사용하여
 * a tag 를 생성하고 페이지 전환을 한다.
 *
 * 하지만 button 등 tag를 사용할때는 onClick event 를 캡쳐하여 페이지를
 ...
 */
function App() {
  // useNavicate hooks 함수를 사용하여 navigate 객체 생성
  const navigate = useNavigate();
  // App Component 내에 inner Componet 를 생성하기
  const AppBody = () => {
    return (
      <div className="App">
