...
if (!strBlank) console.log("strBlank 은", typeof strBlank); // string
if (!numZero) console.log("numZero 은", typeof numZero); // number
if (!valUndefined) console.log("valUndefined 은", typeof valUndefined); // undefined
if (!numNaN) console.log("numNaN 은", typeof numNaN); // number
if (!notNum) console.log("notNum 은", typeof notNum); // bigint
